...
from v1.common.log import LogTypes, log, logger, setup_logging
...
class ValidationError(ServerErrorType):
    OSU_API_KEY_INVALID = "OSU_API_KEY_INVALID"
    OSU_API_V2_CREDENTIALS_INVALID = "OSU_API_V2_CREDENTIALS_INVALID"
    OSU_DAILY_API_KEY_INVALID = "OSU_DAILY_API_KEY_INVALID"


class RepositoryProfileError(ServerErrorType):
    PROFILE_NOT_FOUND = "PROFILE_NOT_FOUND"
    PROFILE_ALREADY_EXISTS = "PROFILE_ALREADY_EXISTS"


class RepositorySessionError(ServerErrorType):
    SESSION_NOT_FOUND = "SESSION_NOT_FOUND"
    SESSION_ALREADY_EXISTS = "SESSION_ALREADY_EXISTS"


class RepositoryConfigError(ServerErrorType):
    CONFIG_NOT_FOUND = "CONFIG_NOT_FOUND"
    CONFIG_ALREADY_EXISTS = "CONFIG_ALREADY_EXISTS"


class OsuDailyAPIError(ServerErrorType):
    OSU_DAILY_API_KEY_INVALID = "OSU_DAILY_API_KEY_INVALID"
